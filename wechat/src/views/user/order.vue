      ...
      <scroller lock-x @on-scroll-bottom="onScrollBottom" ref="scrollerBottom" height="-90" :scroll-bottom-offst="200">
        <div class="item-list">
          <div class="item" v-if="sed_index==0" v-for="item in order_list">
            ...
            <div class="op-btn">
              <div class="reset-btn" @click="edit_order(item)" v-if="role_code=='001' && item.iState!=110">作废</div>
              <div class="confirm-btn" @click="sendDuiDuiJi(item)" v-if="role_code=='001'">打印</div>
              <div class="confirm-btn" @click="ok_order(item)" v-if="role_code=='002' && item.iState==0">确认订单</div>
              <div class="confirm-btn" @click="desend_order(item)" v-if="role_code=='003' && item.iTWState==0">结束订单</div>
          ...
          <div class="item" v-if="sed_index==1" v-for="item in wj_order_list">
            ...
            <div class="op-btn">
              <div class="reset-btn" @click="edit_order(item)" v-if="role_code=='001' && item.iState!=110">作废</div>
              <div class="confirm-btn" @click="end_order(item)" v-if="role_code=='001' && item.iState==0">结束订单</div>
            </div>
          </div>

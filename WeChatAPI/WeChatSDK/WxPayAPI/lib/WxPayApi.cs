...
namespace WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        ...
        /// 初始临时票据
        /// </summary>
        public static string initJSAPITicket()
        {
            String result = "";
            try
            {
                ...
                String accessURL = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=" + WeChatContext.Access_Token + "&type=jsapi";
                ...
                return respDic["ticket"].ToString();

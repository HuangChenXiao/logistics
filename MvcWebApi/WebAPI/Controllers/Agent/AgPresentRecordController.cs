...
{
    public class AgPresentRecordController : ApiController
    {
        ...
        public ResponseMessageResult GetDespoitOrderList(int status, int page, int pagesize, string begindate = "", string enddate = "")
        {
            ...
            if (jwtmodel.isadmin)
            {
                ...
                var query = db.Query("exec PROC_DespoitOrderList @0,@1,@2,@3,@4,@5,@6", begindate, enddate, jwtmodel.userid, 0, status, page, pagesize).ToList();
